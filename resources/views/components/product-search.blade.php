<form action="/products" class="my-auto"    >
    <div class="flex border-2 border-white rounded-lg overflow-hidden">
        <select name="category_id" id="dropdown-button" type="button" class="max-w-[230px] inline-flex justify-center bg-white px-3 py-3 text-sm font-semibold text-gray-900 shadow-sm" id="menu-button" aria-expanded="true" aria-haspopup="true">
