...
<div class="flex flex-row mb-4">
    <div class="mb-4 md:mr-2 md:mb-0" style="width: 50%">
        ...
        <input
            ...
            type="text" name="{{$prefix}}first_name" value="{{old( $prefix . 'first_name', $address->first_name ?? null)}}"  id="" placeholder="First name" />
    ...
    <div class="md:ml-2" style="width: 50%">
        ...
        <input
            ...
            type="text" name="{{$prefix}}last_name" value="{{old( $prefix . 'last_name', $address->last_name ?? null)}}"  id="lastname" placeholder="Last name" />
...
<div class="mb-2">
    ...
    <input
        ...
        id="company_name" name="{{$prefix}}company" value="{{old( $prefix . 'company', $address->company ?? null)}}"  type="text" placeholder="Company Name" />
...
<div class="mb-2">
    ...
    <input
        ...
        id="" name="{{$prefix}}address_line_1" value="{{old( $prefix . 'address_line_1', $address->address_line_1 ?? null)}}"  type="text" placeholder="House number and street name" />
    <x-input-error :messages="$errors->get( $prefix . 'address_line_1')" class="mt-2" />
    <input
        class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
        id="" name="{{$prefix}}address_line_2" value="{{old( $prefix . 'address_line_2', $address->address_line_2 ?? null)}}"  type="text" placeholder="Apartment, suite, unit, etc. (optional)" />
...
<div class="mb-2">
    ...
    <input
        class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
        id="" name="{{$prefix}}city" value="{{old( $prefix . 'city', $address->city ?? null)}}"  type="text" placeholder="Town/City" />
...
<div class="mb-2">
    ...
    <input
        class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
        id="" name="{{$prefix}}zip" value="{{old( $prefix . 'zip', $address->zip ?? null)}}"  type="text" placeholder="Zip Code" />
...
<div class="mb-2">
    ...
    <input
        class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
        id="" name="{{$prefix}}phone" value="{{old( $prefix . 'phone', $address->phone ?? null)}}"  type="number" placeholder="Phone" />
