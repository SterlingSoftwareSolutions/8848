<tr class="font-light bg-white border border-black">
    ...
    <td class="flex items-center justify-center px-6 py-8 mt-8 space-x-2">
        <div class="flex flex-row w-[150px] md:flex-row custom-number-input border-[2px] border-[#1670B7] rounded-md">
            ...
            <!-- Input Field -->
            <input type="number" class="flex items-center w-16 font-semibold text-center text-gray-700 outline-none cursor-default focus:outline-none md:w-full text-md md:text-base" name="custom-input-number" value="{{$cartitem->quantity}}">
            <!-- Increase Button -->
    ...
    <td class="px-6 py-4">
        <form action="/cart/remove/" method="post">
            ...
            <button><i class="w-1/12 fa-solid fa-trash-can"></i></button>
        </form>
    </td>
</tr>