<tr class="font-light bg-white border border-black">
    ...
    <td class="w-2/12 px-6 py-8 mt-4 text-center md:mt-0 md:text-left">
        <div class="md:flex items-center md:justify-center md:mt-0 custom-number-input border-2 border-#1670B7 rounded-md">
            <!-- Decrease Button -->
            <button type="button" data-action="decrement" class="w-8 h-8 md:w-10 md:h-10 text-gray-600 rounded-r cursor-pointer hover:text-gray-700 hover:bg-gray-400">
                <span class="m-auto text-md font-thin">−</span>
            </button>
            <!-- Input Field -->
            <input type="number" class="flex items-center w-10 font-semibold text-center text-gray-700 outline-none cursor-default focus:outline-none text-md" name="variant_quantity_{{$cartitem->variant->id}}" min="1" value="{{$cartitem->quantity}}">
            <!-- Increase Button -->
            <button type="button" data-action="increment" class="w-8 h-8 md:w-10 md:h-10 text-gray-600 rounded-r cursor-pointer hover:text-gray-700 hover:bg-gray-400">
                <span class="m-auto text-md font-thin">+</span>
            </button>
        </div>
    </td>
