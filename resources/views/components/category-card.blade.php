...
<div class="w-full aspect-square bg-gray-200 -skew-x-6 rounded-md bg-cover" style="background-image: url({{$category->background}});">
    <div class="bg-gray-200 w-full h-full bg-opacity-100 text-blue-800 hover:bg-black [&>.image]:hover:invert hover:bg-opacity-50 hover:text-white flex flex-col items-center justify-center">
