        ...
        <form class="w-full md:mt-10">
            <div class="flex flex-row gap-2 md:mt-2">
                <div class="w-1/2">
                    ...
                    <input class="w-full px-3 py-2 text-gray-700 border border-black rounded-md" id="username" type="text" placeholder="Username" />
                </div>

                <div class="w-1/2">
                    <label>Email: <span class="text-red-500"> *</span></label>
                    <input class="w-full px-3 py-2 text-gray-700 border border-black rounded-md" id="email" type="text" placeholder="Email" />
                </div>
            </div>
            ...
            <div class="flex flex-row gap-2">
                <div class="w-1/2 md:mt-5">
                    ...
                    <input class="w-full px-3 py-2 text-gray-700 border border-black rounded-md" id="phone" type="text" placeholder="Phone" />
                </div>

                <div class="w-1/2 md:mt-5">
                    <label>Company:
                        <span class="text-red-500"> *</span></label>
                    <input class="w-full px-3 py-2 text-gray-700 border border-black rounded-md" id="company" type="text" placeholder="Company" />
                </div>
            </div>
