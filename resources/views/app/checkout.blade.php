    ...
    <div class="flex gap-4">
        <div class="flex flex-col w-full">
            <div class="w-full border rounded">
                <div class="w-full col-span-2 p-2 mt-2 ml-4 border-gray-200">Returning customer? <span
                        class="text-blue-400">Click here to login</span></div>
            </div>
                    ...
                    <form class="px-8 pt-6 pb-8 mb-4 bg-white rounded">
                        ...
                        <div class="flex flex-row mb-4">
                            <div class="mb-4 md:mr-2 md:mb-0" style="width: 50%">
                                <label
                                    class="block mb-2 text-sm font-semibold text-gray-700 after:content-['*'] after:ml-0.5 after:text-red-500"
                                    for="firstname">
                                    First Name
                                </label>
                                <input
                                    ...
                                    type="text" name=""  placeholder="First name" value="{{$user?->address_billing?->first_name}}" />
                            </div>
                            <div class="md:ml-2" style="width: 50%">
                                ...
                                <input
                                    ...
                                    type="text" name="" id="lastname" placeholder="Last name" value="{{$user?->address_billing?->last_name}}" />
                            </div>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <input
                                ...
                                id="company_name" type="text" placeholder="Company Name" value="{{$user?->address_billing?->company}}" />
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <input
                                class="w-full px-3 py-2 mb-1 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                 type="text" placeholder="House number and street name" value="{{$user?->address_billing?->address_line_1}}" />
                            <input
                                class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                 type="text" placeholder="Apartment, suite, unit, etc. (optional)" value="{{$user?->address_billing?->address_line_2}}" />
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <input
                                class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                 type="text" placeholder="Town/City" value="{{$user?->address_billing?->city}}" />
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <select
                                class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                name="state" id="state">
                                <option class="text-sm" value="">{{$user?->address_billing?->state}}</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <input
                                class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                 type="text" placeholder="Zip Code" value="{{$user?->address_billing?->zip}}"/>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <input
                                class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                 type="number" placeholder="Phone" value="{{$user?->address_billing?->phone}}" />
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="email" type="email" placeholder="Email" value="{{$user?->address_billing?->email}}" />
                        </div>
                        <hr class="mb-6 border-t" />
                        <div class="text-sm text-left">
                            <input id="create-account" name="account-type" type="radio"
                                    ...
                                    <div class="w-full p-4" id="shipping-details">
                                        <div class="px-8 pb-8 mb-4 bg-white rounded" id="shipping-form">
                                            ...
                                            <div class="flex flex-row mb-4">
                                                <div class="mb-4 md:mr-2 md:mb-0" style="width: 50%">
                                                    ...
                                                    <input
                                                        ...
                                                        value="{{old('shipping_first_name', $user?->address_shipping?->first_name)}}"
                                                         placeholder="First name" {{$user?->address_shipping?->first_name}}/>
                                                    <x-input-error :messages="$errors->get('shipping_first_name')"
                                                        class="mt-2" />
                                                </div>
                                                <div class="md:ml-2" style="width: 50%">
                                                    <label class="block mb-2 text-sm font-semibold text-gray-700"
                                                    ...
                                                    <input
                                                        ...
                                                        value="{{old('shipping_last_name', $user?->address_shipping?->last_name)}}"
                                                        id="lastname" placeholder="Last name" />
                                                    <x-input-error :messages="$errors->get('shipping_last_name')"
                                                        class="mt-2" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input
                                                    class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                                    id="company_name" name="shipping_company"
                                                    value="{{old('shipping_company', $user?->address_shipping?->company)}}"
                                                    type="text" placeholder="Company Name" />
                                                <x-input-error :messages="$errors->get('shipping_company')"
                                                    class="mt-2" />
                                            </div>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select
                                                    class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                                    id="country" name="shipping_state"
                                                    value="{{old('shipping_state', $user?->address_shipping?->state)}}">
                                                    <option class="text-sm" value="California">California</option>
                                                </select>
                                                <x-input-error :messages="$errors->get('shipping_state')"
                                                    class="mt-2" />
                                            </div>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input
                                                    ...
                                                    value="{{old('shipping_address_line_1', $user?->address_shipping?->address_line_1)}}"
                                                    type="text" placeholder="House number and street name" />
                                                <x-input-error :messages="$errors->get('shipping_address_line_1')"
                                                    class="mt-2" />
                                                <input
                                                    class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                                     name="shipping_address_line_2"
                                                    value="{{old('shipping_address_line_2', $user?->address_shipping?->address_line_2)}}"
                                                    type="text" placeholder="Apartment, suite, unit, etc. (optional)" />
                                                <x-input-error :messages="$errors->get('shipping_address_line_2')"
                                                    class="mt-2" />
                                            </div>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input
                                                    class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                                     name="shipping_city"
                                                    value="{{old('shipping_city', $user?->address_shipping?->city)}}"
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input
                                                    class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                                     name="shipping_zip"
                                                    value="{{old('shipping_zip', $user?->address_shipping?->zip)}}"
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input
                                                    class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                                     name="shipping_phone"
                                                    value="{{old('shipping_phone', $user?->address_shipping?->phone)}}"
                                                    type="number" placeholder="Phone" />
                                                <x-input-error :messages="$errors->get('shipping_phone')"
                                                    class="mt-2" />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="mt-4 text-sm">
                            <input id="ship-to-different-address" name="ship-to-different-address" type="radio"
                                class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-600">
                            ...
                            <div id="shipping-address-section" style="display: none;">
                                ...
                                <div class="flex flex-row mt-4">
                                    <div class="mb-4 md:mr-2 md:mb-0">
                                        ...
                                        <input
                                            class="w-full px-3 py-2 mr-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                            type="text" name=""  placeholder="First name" />
                                    </div>
                                    <div class="md:ml-2">
                                        <label
                                            class="block mb-2 text-sm font-semibold text-gray-700 after:content-['*'] after:ml-0.5 after:text-red-500"
        ...
        <div class="flex flex-col w-full md:w-7/12">
            ...
            <div class="w-full border rounded md:w-11/12">
                ...
                <div class="mt-2 ml-4 text-[12px] text-gray-500 after:content-['*'] after:ml-0.5 after:text-red-500">
                    <input id="accept" name="accept" type="radio"
                        class="w-4 h-3 text-indigo-600 border-gray-300 focus:ring-indigo-600">
                    I have read and agree to the website terms and conditions
                </div>
                <div class="p-3">
                    <button type="submit"
                        class="px-10 py-3 mt-3 text-white border-2 rounded-lg bg-gradient-to-b from-[#166EB6] to-[#284297] text-1xl md:mt-10 w-full">Place
                        Order</button>
                </div>
            </div>
        </div>
