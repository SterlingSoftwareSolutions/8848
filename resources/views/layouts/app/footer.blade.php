<footer class="bg-white shadow-inner md:mt-8" style="z-index: -999;">
        ...
        <div class="md:flex md:justify-between">
            ...
            <div class="mb-6 md:mb-0 md:w-1/3">
                <a href="" class="grid items-center justify-center text-center">
                    <img class="w-24 h-24 mx-auto" src="{{ URL('images/logo.png')}}" alt="Logo Image">
                    <p class="mt-4 text-center text-black">Lorem Ipsum Dolor Sit Amet, Consectetur</p>
                </a>
            </div>
            ...
            <div class="flex flex-col gap-5 md:w-6/12 md:flex-row">
                ...
                <div class="flex flex-col ml-8 text-center md:text-left">
                    ...
                    <img class="h-auto mx-auto mt-4 md:ml-[12px] w-28 ml-[80px]" src="{{ URL('images/Download-on-the-App-Store-1.png')}}">
                </div>
            </div>
                ...
                <div class="text-center sm:text-left">
                    ...
                    <ul class="text-gray-500">
                        <li class="flex mb-4">
                            ...
                            <a href="https://www.google.com/maps/@-26.7738869,134.7806741,12.75z?entry=ttu" class="ml-2 hover:underline">Unit 3/1 Everaise Ct, Laverton North VIC 3026</a>
                        </li>
    ...
    <div class="h-10 text-center text-white bg-blue-200 sm:text-center dark:text-gray-400">
