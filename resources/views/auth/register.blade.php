...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased text-gray-900">
        <div class="flex flex-col items-center min-h-screen pt-5 bg-gray-100 sm:justify-center sm:pt-0" style="background-image: url('images/background.jpg'); background-size: 100% 100%;">
            ...
            <div class="w-full px-8 py-6 overflow-hidden shadow-md bg-gradient-to-b from-[#166EB6] to-[#284297] sm:max-w-md sm:rounded-lg">
                {{-- bg image overlay --}}
                {{-- <div class="absolute inset-0 bg-blue-700 bg-opacity-50" style="background-image: url('images/image.jpg'); opacity: 0.5; width:50%; height:50%;"></div> --}}
                ...
                <form method="POST" action="#">
                    ...
                    <div>
                        ...
                        <input id="name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Name"/>
                    ...
                    <div class="mt-4">
                        ...
                        <input id="email" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" type="email" name="email" :value="old('email')" required autocomplete="username" placeholder="Email"/>
